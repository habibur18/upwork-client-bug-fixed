...
import styles from "./LastCallAnalyticsTable1.module.css";

const LastCallAnalyticsTable1: FunctionComponent = () => {
  return (
    <form className={styles.lastCallAnalyticsTable}>
      ...
      <div className={styles.column1}>
        <div className={styles.headerCell1}>
          <h2 className={styles.response1}>Response 1</h2>
        </div>
      ...
      <div className={styles.column2}>
        <div className={styles.headerCell2}>
          <h2 className={styles.response2}>Response 2</h2>
        </div>
...
export default LastCallAnalyticsTable1;
